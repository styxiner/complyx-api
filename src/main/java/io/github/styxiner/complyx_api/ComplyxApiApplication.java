...
public class ComplyxApiApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // Crear usuarios
        createUserIfNotExists("admin", "admin@complyx.local", "contraseña", Set.of(adminRole));
        createUserIfNotExists("tecnico", "tecnico@complyx.local", "contraseña", Set.of(tecnicoRole));
        createUserIfNotExists("auditor", "auditor@complyx.local", "contraseña", Set.of(auditorRole));
    }
